...
const SignIn = ({ setIsLoggedIn }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 relative overflow-hidden bg-gemini-dark text-slate-200">
      ...
      <div className="absolute top-1/4 -right-32 w-96 h-96 bg-gemini-cyan rounded-full mix-blend-screen filter blur-[150px] opacity-20"></div>
      
      <div className="z-10 w-full max-w-md glass-panel p-8 rounded-2xl border border-slate-700/50 shadow-2xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white mb-2">Welcome Back</h2>
          <p className="text-slate-400 text-sm">Sign in to continue to InterviewIQ.</p>
        </div>
        ...
        <p className="text-slate-400 text-sm text-center mt-6">
          ...
          <Link to="/signup" className="text-gemini-cyan hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
