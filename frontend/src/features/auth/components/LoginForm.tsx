    ...
    >
      ...
      <div className="rounded-3xl border border-slate-200/80 bg-white/90 p-6 sm:p-8 shadow-xl shadow-purple-500/5 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/90">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a
                ...
                className="text-[11px] font-bold text-[#5D50EB] hover:underline dark:text-purple-400"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="flex items-center space-x-2 pt-1">
            <input
              ...
              id="remember"
              defaultChecked
              className="h-4 w-4 rounded border-slate-300 text-[#5D50EB] focus:ring-[#5D50EB]"
            />
            <label htmlFor="remember" className="text-xs font-semibold text-slate-600 dark:text-slate-400">
        ...
        <div className="mt-6 text-center text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link href={ROUTES.signup} className="font-bold text-[#5D50EB] hover:underline dark:text-purple-400">
            Create an account
          </Link>
        </div>
